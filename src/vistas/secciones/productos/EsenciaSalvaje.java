...
public class EsenciaSalvaje extends javax.swing.JFrame {
    ...
    public EsenciaSalvaje() {
        initComponents();
        this.nombreProducto = "Esencia Salvaje";
        ...
        Proveedor proveedor = proveedorDAO.obtenerProveedorPorId(2);
